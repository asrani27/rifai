...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            <li><a href="/superadmin/listpengaduan/create" class="btn btn-primary"> <i class="fa fa-home fa-plus"></i>
                    Tambah Data</a></li>
        </ul>
    </div>
    <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->status == null ? 'menunggu' : ($item->status == 1 ?
                                        'diproses':'selesai')}}</td>
                                    <td>
                                        <a href="/superadmin/listpengaduan/edit/{{$item->id}}"
                                            class="btn btn-sm btn-outline-primary">Edit</a>
                                        <a href="/superadmin/listpengaduan/delete/{{$item->id}}"
