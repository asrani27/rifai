...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-list"></i> Perusahaan</h1>
            <p>Selamat Datang, {{Auth::user()->name}}</p>
        </div>

        <ul class="app-breadcrumb breadcrumb side">
            <li><a href="/superadmin/perusahaan/create" class="btn btn-primary"> <i class="fa fa-home fa-plus"></i>
                    Tambah Data</a></li>
        </ul>
    </div>
    <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/superadmin/perusahaan/delete/{{$item->id}}"
