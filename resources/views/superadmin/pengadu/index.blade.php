...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-list"></i> Pengadu</h1>
            <p>Selamat Datang, {{Auth::user()->name}}</p>
        </div>

        <ul class="app-breadcrumb breadcrumb side">
            <li><a href="/superadmin/pengadu/create" class="btn btn-primary"> <i class="fa fa-home fa-plus"></i>
                    Tambah Data</a></li>
        </ul>
    </div>
    <div class="row">
                        ...
                        <table class="table table-hover table-sm table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->telp}}</td>
                                    <td>
                                        <a href="/superadmin/pengadu/edit/{{$item->id}}"
                                            class="btn btn-sm btn-outline-primary">Edit</a>
                                        <a href="/superadmin/pengadu/delete/{{$item->id}}"
